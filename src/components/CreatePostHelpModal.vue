<template>
    ...
    >
        ...
        >
            <v-card>
                <v-card-title>
                    <span class="headline">Here's a brief guide to understand the syntax for writing a Post.</span>
                </v-card-title>
...
export default {
    ...
    watch: {
        showHelpModal: function(newValue) {
            this.$data.dialog = newValue;
            this.$emit('update:showHelpModal', newValue);
        },
